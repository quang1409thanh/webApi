...
const ResetPassword = () => {
    ...
    const handleSubmit = (event) => {
        ...
        axiosClient.post('/reset-password', {token, email, password, password_confirmation: passwordConfirmation})
            .then(response => {
                // Handle success here
            ...
            .catch(error => {
                ...
                if (error.response && error.response.data) {
                    ...
                    showToast('An error occurred while resetting the password.');
                }
            });
    };
