...
const AddUserForm = () => {
    ...
    const [formData, setFormData] = useState({
        ...
        ...(userType === 'aggregationHead' ? {aggregation_point_id: ''} : {transaction_point_id: ''}),
        phone: '',
        address: '',
        details: '',
    });
    ...
    useEffect(() => {
        ...
        axiosClient.get(endpoint)
            .then(({data}) => {
                const dataFieldName = userType === 'aggregationHead' ? 'aggregationPoints' : 'transactionPoints';
        ...
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100">
            ...
            <form onSubmit={handleSubmit} className="max-w-md mx-auto mt-16 p-4 bg-white rounded shadow-md w-full">
                ...
                <div className="mb-4">
                    ...
                    <select
                        id={userType === 'aggregationHead' ? 'aggregation_point_id' : 'transaction_point_id'}
                        name={userType === 'aggregationHead' ? 'aggregation_point_id' : 'transaction_point_id'}
                        value={userType === 'aggregationHead' ? formData.aggregation_point_id : formData.transaction_point_id}
