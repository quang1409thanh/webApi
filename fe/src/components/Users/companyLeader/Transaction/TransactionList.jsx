            ...
            <div className="content-wrapper">
                ...
                <table className="min-w-full bg-white border border-gray-300">
                    ...
                    <tr className="bg-gray-100">
                        <th className="py-2 px-4 border-b">AggregationID</th>
                    ...
                    {transactionList.map((element) => (
                        <tr key={element.id}>
                            <td className="py-2 px-4 border-b">{element.aggregation_point_id}</td>
                                    ...
                                    onSubmit={(event) => {
                                        ...
                                        if (isConfirmed) {
                                            try {
                                                ...
                                                const response = axiosClient.delete(`transactionPoint/${element.id}`);
