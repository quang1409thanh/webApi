    ...
    return (
        <div className="max-w-xl mx-auto mt-8 p-6 bg-white rounded-lg shadow-md">
            ...
            <div className="grid grid-cols-2 gap-4 mb-4">
                <div className="col-span-1">
                    <p className="text-lg"><span className="font-bold">ID:</span> {profile.id}</p>
                    <p className="text-lg"><span className="font-bold">Name:</span> {profile.name}</p>
            ...
            <div className="mb-8">
                ...
                <form onSubmit={handleForgotPassword} className="max-w-md mx-auto">
                    ...
                    <button
                        type="submit"
                        className="w-full py-2 text-white bg-green-500 rounded-md hover:bg-green-600 focus:outline-none focus:ring focus:border-green-300"
                    >
