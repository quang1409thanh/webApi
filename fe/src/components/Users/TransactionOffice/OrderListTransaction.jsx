                        ...
                        <div className="container_product_list">
                            {checkProduct ? (
                                <div className="nav_bar_service">
                                    ...
                                    <input type="button" value="Tạo túi hàng" id="btn_tao_tui" className="check_btn"
                                           disabled/>
                                    {/* Uncomment the line below if needed */}
                                    ...
                                    <table id="product_list_table">
                                        ...
                                        {dataList.map(item => (
                                            <tr key={item.id}>
                                                <td>
                                                    {item.check_ && (
                                                        <input type="checkbox" name="check_list" id={item._id}
                                                ...
                                                <td>
                                                  <span>
                                                    <select
                                                        ...
                                                        className="select_trang_thai"
                                                        onChange={(e) => handleChangeSelect(e, item.id)}
                                                    >
