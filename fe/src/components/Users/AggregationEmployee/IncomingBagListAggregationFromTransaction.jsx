            ...
            <main className="main_content">
                <div id="mainContent">
                    <div className="full_container">
                        <div className="content_title">
                            DANH SÁCH TÚI HÀNG ĐẾN TỪ ĐIỂM GIAO DỊCH.
                        </div>
                ...
                <input type="button" value="ALL" /> */}
                            ...
                            <table id="product_list_table">
                                ...
                                {listIncomingFromTransaction.map(item => (
                                    <tr key={item.id}>
                                        <td>{item.id}</td>
                                        <td>{item.status}</td>
                                        ...
                                        <td className="py-2 px-4 border-b">
                                            <form
                                                method="DELETE"
                                                onSubmit={(event) => handleDelete(event, item.shipmentGdTk.id)}>
                                                <button type="submit"
...
export default IncomingBagListAggregationFromTransaction;
